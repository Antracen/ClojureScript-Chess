...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"square-clicked","square-clicked",707081567),(function (db,p__27278){
var vec__27279 = p__27278;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27279,(0),null);
var vec__27282 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27279,(1),null);
var rank = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27282,(0),null);
var file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27282,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("reframe.core","websocket-connected","reframe.core/websocket-connected",-648968167),(function (_,___$1){
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Connected to websocket!"], 0));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("reframe.core","game-updated","reframe.core/game-updated",-2016325830),(function (coeffects,p__27285){
var vec__27286 = p__27285;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27286,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27286,(1),null);
var db = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(coeffects);
...
reframe.core.piece_img = (function reframe$core$piece_img(p__27289){
var map__27290 = p__27289;
var map__27290__$1 = cljs.core.__destructure_map(map__27290);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27290__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var piece = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27290__$1,new cljs.core.Keyword(null,"piece","piece",1396691784));
...
var iter__4611__auto__ = (function reframe$core$chess_board_$_iter__27291(s__27292){
return (new cljs.core.LazySeq(null,(function (){
var s__27292__$1 = s__27292;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__27292__$1);
if(temp__5753__auto__){
var xs__6308__auto__ = temp__5753__auto__;
var rank = cljs.core.first(xs__6308__auto__);
var iterys__4607__auto__ = ((function (s__27292__$1,rank,xs__6308__auto__,temp__5753__auto__,rank_range,file_range){
return (function reframe$core$chess_board_$_iter__27291_$_iter__27293(s__27294){
return (new cljs.core.LazySeq(null,((function (s__27292__$1,rank,xs__6308__auto__,temp__5753__auto__,rank_range,file_range){
return (function (){
var s__27294__$1 = s__27294;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__27294__$1);
if(temp__5753__auto____$1){
var s__27294__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__27294__$2)){
var c__4609__auto__ = cljs.core.chunk_first(s__27294__$2);
var size__4610__auto__ = cljs.core.count(c__4609__auto__);
var b__27296 = cljs.core.chunk_buffer(size__4610__auto__);
if((function (){var i__27295 = (0);
while(true){
if((i__27295 < size__4610__auto__)){
var file = cljs.core._nth(c__4609__auto__,i__27295);
cljs.core.chunk_append(b__27296,(function (){var piece = cljs.core.get.cljs$core$IFn$_invoke$arity$2(board,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reframe.chess.number_to_letter(file),rank], null));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27296),reframe$core$chess_board_$_iter__27291_$_iter__27293(cljs.core.chunk_rest(s__27294__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27296),null);
}
} else {
var file = cljs.core.first(s__27294__$2);
...
})(),reframe$core$chess_board_$_iter__27291_$_iter__27293(cljs.core.rest(s__27294__$2)));
}
} else {
return null;
}
...
});})(s__27292__$1,rank,xs__6308__auto__,temp__5753__auto__,rank_range,file_range))
,null,null));
});})(s__27292__$1,rank,xs__6308__auto__,temp__5753__auto__,rank_range,file_range))
;
var fs__4608__auto__ = cljs.core.seq(iterys__4607__auto__(file_range));
if(fs__4608__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4608__auto__,reframe$core$chess_board_$_iter__27291(cljs.core.rest(s__27292__$1)));
} else {
var G__27298 = cljs.core.rest(s__27292__$1);
s__27292__$1 = G__27298;
continue;
}
} else {
return null;
