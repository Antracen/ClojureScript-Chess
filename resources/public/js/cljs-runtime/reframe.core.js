...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"square-clicked","square-clicked",707081567),(function (db,p__27047){
var vec__27048 = p__27047;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27048,(0),null);
var vec__27051 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27048,(1),null);
var rank = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27051,(0),null);
var file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27051,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("reframe.core","game-updated","reframe.core/game-updated",-2016325830),(function (coeffects,p__27054){
var vec__27055 = p__27054;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27055,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27055,(1),null);
var db = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(coeffects);
...
reframe.core.piece_img = (function reframe$core$piece_img(p__27058){
var map__27059 = p__27058;
var map__27059__$1 = cljs.core.__destructure_map(map__27059);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27059__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var piece = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27059__$1,new cljs.core.Keyword(null,"piece","piece",1396691784));
...
var iter__4611__auto__ = (function reframe$core$chess_board_$_iter__27060(s__27061){
...
var iterys__4607__auto__ = ((function (s__27061__$1,rank,xs__6308__auto__,temp__5753__auto__,rank_range,file_range){
return (function reframe$core$chess_board_$_iter__27060_$_iter__27062(s__27063){
return (new cljs.core.LazySeq(null,((function (s__27061__$1,rank,xs__6308__auto__,temp__5753__auto__,rank_range,file_range){
return (function (){
var s__27063__$1 = s__27063;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__27063__$1);
if(temp__5753__auto____$1){
var s__27063__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__27063__$2)){
var c__4609__auto__ = cljs.core.chunk_first(s__27063__$2);
var size__4610__auto__ = cljs.core.count(c__4609__auto__);
var b__27065 = cljs.core.chunk_buffer(size__4610__auto__);
if((function (){var i__27064 = (0);
while(true){
if((i__27064 < size__4610__auto__)){
var file = cljs.core._nth(c__4609__auto__,i__27064);
cljs.core.chunk_append(b__27065,(function (){var piece = cljs.core.get.cljs$core$IFn$_invoke$arity$2(board,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reframe.chess.number_to_letter(file),rank], null));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27065),reframe$core$chess_board_$_iter__27060_$_iter__27062(cljs.core.chunk_rest(s__27063__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27065),null);
}
} else {
var file = cljs.core.first(s__27063__$2);
...
})(),reframe$core$chess_board_$_iter__27060_$_iter__27062(cljs.core.rest(s__27063__$2)));
}
} else {
return null;
}
...
});})(s__27061__$1,rank,xs__6308__auto__,temp__5753__auto__,rank_range,file_range))
,null,null));
});})(s__27061__$1,rank,xs__6308__auto__,temp__5753__auto__,rank_range,file_range))
;
var fs__4608__auto__ = cljs.core.seq(iterys__4607__auto__(file_range));
if(fs__4608__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4608__auto__,reframe$core$chess_board_$_iter__27060(cljs.core.rest(s__27061__$1)));
} else {
var G__27067 = cljs.core.rest(s__27061__$1);
s__27061__$1 = G__27067;
continue;
}
} else {
return null;
