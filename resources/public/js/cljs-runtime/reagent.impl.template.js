...
var G__26467 = o;
goog.object.set(G__26467,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__26468 = o;
goog.object.set(G__26468,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__26492__i < G__26492__a.length) {G__26492__a[G__26492__i] = arguments[G__26492__i + 0]; ++G__26492__i;}
  args = new cljs.core.IndexedSeq(G__26492__a,0,null);
} 
...
var G__26469 = props;
var G__26469__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26469,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26469);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26469__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26470,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26470;
}
})(),id_class);
...
var G__26471 = (cljs.core.count(argv) - first_child);
switch (G__26471) {
case (0):
...
var vec__26472 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26472,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26472,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26472,(2),null);
...
var temp__5757__auto___26510 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___26510 == null)){
} else {
var key_26513 = temp__5757__auto___26510;
(jsprops.key = key_26513);
}
...
var temp__5757__auto___26514 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___26514 == null)){
} else {
var key_26515 = temp__5757__auto___26514;
(jsprops.key = key_26515);
}
...
var temp__5757__auto___26517 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___26517 == null)){
} else {
var key_26518 = temp__5757__auto___26517;
...
var temp__5757__auto___26521 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___26521 == null)){
} else {
var key_26525 = temp__5757__auto___26521;
(jsprops.key = key_26525);
}
...
var temp__5757__auto___26530 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___26530 == null)){
} else {
var key_26531 = temp__5757__auto___26530;
(jsprops.key = key_26531);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26475_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26475_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26476 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26476,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26476,(1),null);
...
var G__26480 = tag;
var G__26480__$1 = (((G__26480 instanceof cljs.core.Keyword))?G__26480.fqn:null);
switch (G__26480__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template26482 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template26482 = (function (opts,id,fn_to_element,meta26483){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26482.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26484,meta26483__$1){
var self__ = this;
var _26484__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26482(self__.opts,self__.id,self__.fn_to_element,meta26483__$1));
}));

(reagent.impl.template.t_reagent$impl$template26482.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26484){
var self__ = this;
var _26484__$1 = this;
return self__.meta26483;
}));

(reagent.impl.template.t_reagent$impl$template26482.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26482.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26482.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26482.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26482.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta26483","meta26483",-1501976814,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26482.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26482.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26482");

(reagent.impl.template.t_reagent$impl$template26482.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template26482");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26482.
 */
reagent.impl.template.__GT_t_reagent$impl$template26482 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template26482(opts__$1,id__$1,fn_to_element__$1,meta26483){
return (new reagent.impl.template.t_reagent$impl$template26482(opts__$1,id__$1,fn_to_element__$1,meta26483));
});

}

return (new reagent.impl.template.t_reagent$impl$template26482(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
