...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26499 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26499(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26505 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26505(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26522 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26522(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26528 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26528(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26536 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26536(h);
}
});
