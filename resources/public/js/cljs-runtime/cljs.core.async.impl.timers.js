...
var i_28849 = (self__.level + (1));
while(true){
if((i_28849 <= (new_level + (1)))){
(update[i_28849] = self__.header);

var G__28850 = (i_28849 + (1));
i_28849 = G__28850;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_28851 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_28851[i]));
} else {
x__$2.forward.push((((i < links_28851.length))?(links_28851[i]):null));
}

if((i < links_28851.length)){
(links_28851[i] = x__$2);
} else {
links_28851.push(x__$2);
}
...
var i_28860 = (0);
while(true){
if((i_28860 <= self__.level)){
var links_28861 = (update[i_28860]).forward;
if((x__$1 === (((i_28860 < links_28861.length))?(links_28861[i_28860]):null))){
(links_28861[i_28860] = (x__$1.forward[i_28860]));

var G__28862 = (i_28860 + (1));
i_28860 = G__28862;
continue;
} else {
var G__28863 = (i_28860 + (1));
i_28860 = G__28863;
continue;
}
} else {
